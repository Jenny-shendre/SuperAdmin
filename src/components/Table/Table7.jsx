...
const Table7 = () => {
  ...
  return (
    <div style={{display:'flex', overflow:'hidden'}} className={`wrapper ${action}`}>
    <div className="bg-[#F7F3E8] p-4">
      ...
      <div className="flex mb-4 mt-4 ml-[730px]">
        <button className="bg-[#3D2314] text-white px-4 py-2 rounded-l-3xl" onClick={chequeLog}>Service Log</button>
        <button className="bg-white text-brown-700 px-4 py-2 rounded-r-3xl border border-brown-700" onClick={serviceLog}>Cheque log</button>
      </div>
<div style={{display:'flex', alignItems:'center', width:'1458px',height:'500px'}}>
      ...
      <div className='service'>
        ...
        <div style={{position:'absolute', translate:'1622px'}}>
        <div className="flex items-center justify-center   p-4 cheque" style={{ textAlign:'center'}}>
      <table className="w-[692] h-[363] bg-white border border-gray-300">
        <thead >
       
          <tr className=" text-center text-white w-[153] h-[27] "
           style={{
            fontFamily: "Manrope",
            fontWeight: "500",
            fontSize: "14px",
            ...
            <th className="py-2 px-4 bg-[#3D2314]  border-b">Date</th>
            <th className="py-2 px-4 bg-[#3D2314] border-b">Customer Name</th>
            <th className="py-2 px-4 bg-[#3D2314] border-b">Customer ID</th>
            <th className="py-2 px-4 bg-[#3D2314] border-b">Customer Mobile No</th>
            <th className="py-2 px-4 bg-[#3D2314] border-b">Cheque Photo</th>
          </tr>
        </thead>
        <tbody className="bg-white text-center [#000000]"
        style={{
            fontFamily: "Manrope",
            fontSize: "16px",
            fontWeight: "500",
          ...
          {chequedata.map((row, index) => (
            <tr key={index}>
              ...
              <td className="py-2 px-4 border-b ml-[100px]"
              style={{
                // justifyContent: "center",
                alignItems: "center",
              }}>
              <MdOutlineImage className=" " />
              </td>
            </tr>
          ))}
        </tbody>
