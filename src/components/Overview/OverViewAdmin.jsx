...
const OverViewAdmin = () => {
  ...
  const fetchChannelVisitors = async (interval) => {
    const response = await axios.get('https://project-rof.vercel.app/api/overview/channel-visitors', {
      params: { interval }
    });
    return response.data;
  };
  ...
  const dealsClosedResponse = async (interval) => {
    const response = await axios.get('https://project-rof.vercel.app/api/overview/total-DealsClosed', {
      params: { interval }
    });
    return response.data;
  };
  ...
  const fetchTotalMeetings = async (interval) => {
    const response = await axios.get('https://project-rof.vercel.app/api/overview/total-meetings', {
      params: { interval }
    });
    return response.data;
  };
  ...
  const TopExecutivePerformer = async (interval) => {
    const response = await axios.get('https://project-rof.vercel.app/api/overview/Top_Executive', {
      params: { interval }
    });
    return response.data;
  };
